...
kal_uint32 		g_wensheng_flag = 0;


extern int set_lenovo_charger_status();
...
//add by yinyapeng ==>
		...
		if (g_call_state == 1  && g_lcmSuspend == 1) {
			printk("yinyapeng set CHARGE_CURRENT_300_00_MA in set_jeita_charging_current\n");
...
static void pchr_turn_on_charging(void)
{
	...
	//else
	//{
		//set_lenovo_charger_status(); //set_jeita_charging_current();
	//}
...
printk("linmingchuang1 add g_call_state = %d\n",g_wensheng_flag);
printk("linmingchuang2 add g_lcmSuspend = %d\n",g_wensheng_flag);
printk("linmingchuang3 add g_wensheng_flag1 = %d\n",g_wensheng_flag);

if (g_call_state == 1 && g_lcmSuspend == 1) {
      if(g_wensheng_flag <10)
       {
          g_wensheng_flag++;
          printk("linmingchuang add g_wensheng_flag1 = %d\n",g_wensheng_flag);
       }
else
    {
      printk("linmingchuang add g_wensheng_flag3 = %d\n",g_wensheng_flag);
      msleep(1000);
      g_wensheng_flag=0;
   }
...
else
   {
               ...
               msleep(1000);
               printk("linmingchuang add g_wensheng_flag2 = %d\n",g_wensheng_flag);
